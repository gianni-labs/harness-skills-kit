...
This file provides guidance to Codex (y otros agentes de código que lean `AGENTS.md`) when working with code in this repository. Es el espejo de `CLAUDE.md`: ante cualquier divergencia, ambos deben mantenerse sincronizados.
